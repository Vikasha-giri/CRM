                ...
                <div className="modal-content rounded-4">
                    <div className="modal-body p-lg-5 p-md-4">
                        <div className="d-flex align-items-center justify-content-between">
                            <h5 className="modal-title h4" id="workflowLabel">Add to Campaign / Workflow</h5>
                        ...
                        <hr />
                            <div className="px-xxl-4 px-lg-3">
                                <h4 className="mt-md-4 mt-3 pt-lg-2 pt-xxl-3 mb-3">Add the following contacts</h4>
                                <div
                                ...
                                <div className="bg-light rounded text-primary p-3 ff-primary fw-medium">
                                    <div className="d-flex justify-content-start mb-3 mb-md-4">
                                        <i className="fa-solid fa-triangle-exclamation fa-xl mt-3 me-xl-3 me-2"></i>
                                        <span>Please note you already have 2 "Add to Campaign/Workflow" operations in progress</span>
                                    </div>
